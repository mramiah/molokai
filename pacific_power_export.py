"""
Utility to export Pacific Power SCADA graph to JSON and CSV.
"""
import json
import csv
from pacific_power_scada_schema import create_pacific_power_scada
...
def main():
    ...
    print('JSON export complete: pacific_power_scada_data.json')
    ...
    print('CSV export complete: pacific_power_components.csv')
    ...
    print('CSV export complete: pacific_power_connections.csv')
